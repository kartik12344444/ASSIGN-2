  ...
  render() {
    ...
    return (
      <>
        ...
        <form action="">
          <label className='input1' htmlFor="name">Name   :</label>
          <input
            type="text"
            name="name"
            id="name"
          ...
          <label className='secondinput' htmlFor="department">Department :</label>
          <input
            type="text"
            name="department"
            id="department"
          ...
          <label className="lastinput" htmlFor="rating">Rating :</label>
          <input
            type="number"
            name="rating"
            id="rating"
